<?php $pageTitle = 'Modificar Inscripción'; ?>
    ...
    <div class="container mt-3 mb-5">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                ...
                <form action="index.php?c=GestionInscripciones&m=modificarinscripcion_completa&id=<?php echo (int)$datos['id_inscripcion']; ?>" method="post" novalidate>
                    ...
                    <div class="d-flex justify-content-center gap-2 mb-4">
                        <button type="submit" name="accion" value="guardar" class="btn btn-volver px-4">
